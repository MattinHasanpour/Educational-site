                                ...
                                <div class="tab-pane fade" id="course-pills-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
                                    ...
                                    <div class="card mb-0 mb-md-4">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-md-5">
                                                <!-- Image -->
                                                <img src="front/images/instructor/01.jpg" class="img-fluid rounded-3" alt="instructor-image">
                                            </div>
                                            <div class="col-md-7">
                                                <!-- Card body -->
                                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="d-md-flex my-4">
                                            ...
                                            <div class="avatar avatar-xl me-4 flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="front/images/avatar/09.jpg" alt="avatar">
                                            </div>
                                            <!-- Text -->
                                            <div>
                                        ...
                                        <div class="d-md-flex mb-4 ps-4 ps-md-5">
                                            ...
                                            <div class="avatar avatar-lg me-4 flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="front/images/avatar/02.jpg" alt="avatar">
                                            </div>
                                            <!-- Text -->
                                            <div>
                                                <div class="d-sm-flex mt-1 mt-md-0 align-items-center">
                                        ...
                                        <div class="d-md-flex my-4">
                                            <!-- Avatar -->
                                            <div class="avatar avatar-xl me-4 flex-shrink-0">
                                                <img class="avatar-img rounded-circle" src="front/images/avatar/07.jpg" alt="avatar">
                                            </div>
                                            <!-- Text -->
                                            <div>
                                                <div class="d-sm-flex mt-1 mt-md-0 align-items-center">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex mb-4">
                                                ...
                                                <div class="avatar avatar-sm flex-shrink-0 me-2">
                                                    <a href="#"> <img class="avatar-img rounded-circle" src="front/images/avatar/09.jpg" alt=""> </a>
                                                </div>
                                                    ...
                                                    <li class="comment-item">
                                                        <div class="d-flex mb-3">
                                                            ...
                                                            <div class="avatar avatar-sm flex-shrink-0">
                                                                <a href="#"><img class="avatar-img rounded-circle" src="front/images/avatar/05.jpg" alt=""></a>
                                                            </div>
                                                            <div class="ms-2">
                                                                <!-- Comment by -->
                                                            ...
                                                            <li class="comment-item">
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="avatar avatar-xs flex-shrink-0">
                                                                        <a href="#"><img class="avatar-img rounded-circle" src="front/images/avatar/06.jpg" alt=""></a>
                                                                    </div>
                                                                    <!-- Comment by -->
                                                                    <div class="ms-2">
                                                                        <div class="bg-light p-3 rounded">
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                    <li class="comment-item">
                                                        <div class="d-flex">
                                                            <!-- Avatar -->
                                                            <div class="avatar avatar-sm flex-shrink-0">
                                                                <a href="#"><img class="avatar-img rounded-circle" src="front/images/avatar/02.jpg" alt=""></a>
                                                            </div>
                                                            <div class="ms-2">
                                                                <!-- Comment by -->
                                                                <div class="bg-light p-3 rounded">
                        ...
                        <div class="col-md-6 col-lg-12">
                            ...
                            <div class="card shadow p-2 mb-4 z-index-9">
                                <div class="overflow-hidden rounded-3">
                                    <img src="front/images/courses/4by3/01.jpg" class="card-img" alt="course image">
                                    <!-- Overlay -->
                        ...
                        <div class="col-md-6 col-lg-12">
                            ...
                            <div class="card card-body shadow p-4 mb-4">
                                ...
                                <div class="row gx-3 mb-3">
                                    <!-- Image -->
                                    <div class="col-4">
                                        <img class="rounded" src="front/images/courses/4by3/21.jpg" alt="">
                                    </div>
                                    <!-- Info -->
                                    <div class="col-8">
                                ...
                                <div class="row gx-3">
                                    <!-- Image -->
                                    <div class="col-4">
                                        <img class="rounded" src="front/images/courses/4by3/18.jpg" alt="">
                                    </div>
                                    <!-- Info -->
                                    <div class="col-8">
                    ...
                    <div class="tiny-slider-inner" data-autoplay="false" data-arrow="true" data-edge="2" data-dots="false" data-items="3" data-items-lg="2" data-items-sm="1">
                            ...
                            <div class="card p-2 border">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <img src="front/images/courses/4by3/17.jpg" class="card-img-top" alt="course image">
                                    </div>
                                    <!-- Hover element -->
                        ...
                        <div class="pb-4">
                            <div class="card p-2 border">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <img src="front/images/courses/4by3/18.jpg" class="card-img-top" alt="course image">
                                    </div>
                                    <!-- Hover element -->
                                    <div class="card-img-overlay">
                                        <div class="card-element-hover d-flex justify-content-end">
                        ...
                        <div class="pb-4">
                            <div class="card p-2 border">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <img src="front/images/courses/4by3/21.jpg" class="card-img-top" alt="course image">
                                    </div>
                                    <!-- Hover element -->
                                    <div class="card-img-overlay">
                                        <div class="card-element-hover d-flex justify-content-end">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <!-- Avatar -->
                                        <div class="avatar avatar-sm">
                                            <img class="avatar-img rounded-circle" src="front/images/avatar/05.jpg" alt="avatar">
                                        </div>
                                    </div>
                                    <!-- Divider -->
                                    <hr>
                        ...
                        <div class="pb-4">
                            <div class="card p-2 border">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <img src="front/images/courses/4by3/20.jpg" class="card-img-top" alt="course image">
                                    </div>
                                    <!-- Hover element -->
                                    <div class="card-img-overlay">
                                        <div class="card-element-hover d-flex justify-content-end">
