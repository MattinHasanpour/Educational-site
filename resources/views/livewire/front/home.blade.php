        ...
        <div class="container">
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                    ...
                    <!-- Content -->
                    <p class="my-4">بازار آنلاین آموزش و یادگیری با بیش از 5K دوره و 10 میلیون دانشجو. توسط متخصصان
                        آموزش داده می شود تا به شما در کسب مهارت های جدید کمک کند.</p>
                ...
                <div class="col-lg-7 col-xl-6 text-center position-relative">
                    ...
                    <div
                        ...
                        <img src="front/images/client/science.svg" alt="Icon">
                    </div>
                    <div class="p-2 bg-white shadow rounded-3 position-absolute top-0 end-0 me-5">
                        <img src="front/images/client/angular.svg" alt="Icon">
                    </div>
                    <div
                        ...
                        <img src="front/images/client/figma.svg" alt="Icon">
                    </div>
                    <!-- Icon logos END -->
                    ...
                    <div
                        ...
                        style="background:url(front/images/pattern/01.png) no-repeat center center; background-size:cover;">
                        <p class="text-white">دانشجویان جدید امروز ما</p>
                        <!-- Avatar group -->
                        <ul class="avatar-group mb-0">
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="front/images/avatar/01.jpg"
                                     alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="front/images/avatar/02.jpg"
                                     alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="front/images/avatar/03.jpg"
                                     alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                                <img class="avatar-img rounded-circle border-white" src="front/images/avatar/04.jpg"
                                     alt="avatar">
                            </li>
                            <li class="avatar avatar-sm">
                    ...
                    <div class="position-relative">
                        <img src="front/images/element/07.png" alt="">
                    </div>
                </div>
                <!-- Right content END -->
            </div>
            ...
            <ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab"
                ...
                <li class="nav-item me-2 me-sm-5">
                    <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-1" aria-selected="false">طراحی وب
                    </button>
                </li>
                <!-- Tab item -->
                <li class="nav-item me-2 me-sm-5">
                    <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-2" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-2" aria-selected="false">برنامه نویسی
                    </button>
                </li>
                <!-- Tab item -->
                <li class="nav-item me-2 me-sm-5">
                    <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-3" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-3" aria-selected="false">طراحی گرافیکی
                    </button>
                </li>
                <!-- Tab item -->
                <li class="nav-item me-2 me-sm-5">
                    <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-4" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-4" aria-selected="false">دیجیتال مارکتنیگ
                    </button>
                </li>
                <!-- Tab item -->
                <li class="nav-item me-2 me-sm-5">
                    <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-5" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-5" aria-selected="false">بازار مالی
                    </button>
                </li>
            </ul>
            <!-- Tabs END -->
                ...
                <div class="tab-pane fade show active" id="course-pills-tabs-1" role="tabpanel"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <p class="mb-2 text-truncate-2">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
                                        طراحان گرافیک</p>
                                    <!-- Rating star -->
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <p class="text-truncate-2 mb-2">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
                                        طراحان گرافیک</p>
                                    <!-- Rating star -->
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                <!-- Image -->
                                <img src="front/images/courses/4by3/09.jpg" class="card-img-top" alt="course image">
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-2">
                                        <a href="#" class="badge bg-purple bg-opacity-10 text-purple">همه سطح</a>
                            ...
                            <div class="col-11 mx-auto position-relative">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <p class="text-white mb-3 mb-lg-0">ارائه راهکارها و شرایط سخت تایپ به پایان رسد
                    ...
                    <div class="tiny-slider-inner pb-1" data-autoplay="true" data-arrow="true" data-edge="2"
                        ...
                        <div>
                            <div class="card action-trigger-hover border bg-transparent">
                                <!-- Image -->
                                <img src="front/images/courses/4by3/14.jpg" class="card-img-top" alt="course image">
                                <!-- Ribbon -->
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-1" src="front/images/avatar/10.jpg"
                                                     alt="avatar">
                                            </div>
                                            <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">مهرداد نوروزی</a>
                                            </p>
                                        </div>
                                        <!-- Price -->
                                        <div>
                        ...
                        <div>
                            <div class="card action-trigger-hover border bg-transparent">
                                <!-- Image -->
                                <img src="front/images/courses/4by3/15.jpg" class="card-img-top" alt="course image">
                                <!-- Card body -->
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-3">
                                ...
                                <div class="card-footer pt-0 bg-transparent">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-1" src="front/images/avatar/04.jpg"
                                                     alt="avatar">
                                            </div>
                            ...
                            <div class="card action-trigger-hover border bg-transparent">
                                ...
                                <div class="card-footer pt-0 bg-transparent">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-1" src="front/images/avatar/09.jpg"
                                                     alt="avatar">
                                            </div>
                                            <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">الهام نصرتی</a>
                                            </p>
                                        </div>
                                        <!-- Price -->
                                        <div>
                        ...
                        <div>
                            <div class="card action-trigger-hover border bg-transparent">
                                <!-- Image -->
                                <img src="front/images/courses/4by3/16.jpg" class="card-img-top" alt="course image">
                                <!-- Card body -->
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-3">
                                ...
                                <div class="card-footer pt-0 bg-transparent">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-1" src="front/images/avatar/01.jpg"
                                                     alt="avatar">
                                            </div>
        ...
        <div class="container">
            <div class="row g-4 g-lg-5 align-items-center">
                        ...
                        <div class="col-md-7 position-relative mb-0 mt-0 mt-md-5">
                            ...
                            <div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                                ...
                                <div class="avatar avatar-xl mb-3">
                                    <img class="avatar-img rounded-circle" src="front/images/avatar/01.jpg"
                                         alt="avatar">
                                </div>
                                <!-- Content -->
                                <blockquote>
                        ...
                        <div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
                            <div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                                ...
                                <div class="d-flex align-items-center">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="front/images/avatar/02.jpg"
                                             alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                    ...
                    <div class="row mt-5 mt-xl-0">
                        ...
                        <div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                            ...
                            <div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center"
                                 style="background:url(front/images/pattern/02.png) no-repeat center center; background-size:cover;">
                                <!-- Info -->
                        ...
                        <div class="col-md-5 mt-n6 mb-0 mb-md-5">
                            <div class="bg-body shadow text-center p-4 rounded-3">
                                <!-- Avatar -->
                                <div class="avatar avatar-xl mb-3">
                                    <img class="avatar-img rounded-circle" src="front/images/avatar/03.jpg"
                                         alt="avatar">
                                </div>
                                <!-- Content -->
                                <blockquote>
                ...
                <div class="col-xl-5 order-1 text-center text-xl-start">
                    ...
                    <p>با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت
